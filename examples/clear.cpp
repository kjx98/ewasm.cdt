...
static ewasm_argument arg7[] = {
    {UINT32}, {UINT32}, {UINT64}, {UINT16}, {UINT16}, {BOOL}, {BOOL},
};
...
void ewasm_main(const u32 Id, const ewasm_method *mtdPtr) {
  ...
  case 0xbe704381:
    // dealClearing, arg7
    doClear(arg7[0]._nValue, arg7[1]._nValue, arg7[2]._nValue, arg7[3]._nValue,
            arg7[4]._nValue, arg7[5]._nValue, arg7[6]._nValue);
    break;
  case 0xf42a90d6:
    // getClientPosition, arg3
    {
      auto idx =
          memSymbolIdx(arg3[1]._nValue, arg3[2]._nValue, arg3[0]._nValue);
      bytes32 key(idx);
      eth_storageLoad(&key, &val32);
      memPosition *mp = (memPosition *)((void *)&val32);
