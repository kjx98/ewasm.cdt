...
void ewasm_main(const u32 Id, const ewasm_method *mtdPtr) {
  static_assert(sizeof(method) == sizeof(ewasm_method),
                "size of ewasm_method and method MUST equal");
  static_assert(sizeof(ABI) == sizeof(ewasm_ABI),
                "size of ewasm_ABI and ABI MUST equal");
  u32 n = 10;
